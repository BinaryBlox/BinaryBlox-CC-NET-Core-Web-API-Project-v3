...
using BinaryBlox.SDK.Configuration.Mapper; 

using IdentityServer4.AccessTokenValidation;
 
using {{cookiecutter.project_api_pkg_configuration}}.Constants;
using {{cookiecutter.project_api_pkg_configuration}}.DAL;
using {{cookiecutter.project_api_pkg_configuration}}.DAL.Configuration;
using {{cookiecutter.project_api_pkg_configuration}}.Microservice.Mapper;
...
namespace {{cookiecutter.project_api_pkg_configuration}}
{
    ...
    public class Startup: BxStartup
    {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IIdentityDbContext, BxConfigurationIdentityDbContext>();
            services.AddScoped<DbContext, BxApplicationDbContext>();
            services.AddScoped<BxIdentityDbContext, BxConfigurationIdentityDbContext>();
            //services.AddScoped<BxConfigurationIdentityDbContext, BxConfigurationIdentityDbContext>()

            // DB Creation and Seeding 
            services.AddTransient<IBxDataInitializer, BxConfigurationDataInitializer>();
        ...
        public override void ConfigureDbProviderMSSQL(IServiceCollection services)
        {
            ...
            services.AddDbContext<BxConfigurationIdentityDbContext>(options =>
        ...
        public override void ConfigureIdentityServerOptions(IServiceCollection services)
        {
            ...
            **/ 
            services.AddIdentity<ApplicationUser, ApplicationRole>()
                    .AddEntityFrameworkStores<BxConfigurationIdentityDbContext>();
