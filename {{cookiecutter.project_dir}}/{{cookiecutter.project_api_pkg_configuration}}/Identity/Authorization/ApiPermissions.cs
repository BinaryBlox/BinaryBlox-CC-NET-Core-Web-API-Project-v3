...
namespace {{cookiecutter.project_api_pkg_configuration}}.Identity.Authorization
{
    public static class ApiPermissions
    { 
        public static ReadOnlyCollection<ApiPermission> AllPermissions;

        public const string ApiName = "{{cookiecutter.project_api_name_configuration}}"; 
        public const string ApiPrefixName = "{{cookiecutter.project_api_const_pfx_configuration}}"; 
 
        //-------------------------------------
        // {{cookiecutter.project_api_name_configuration}} User & Role Management Permissions
        //-------------------------------------
