...
/*
INSERT INTO [{{cookiecutter.project_db_name}}].[dbo].[client_cors_origins]
([Origin] ,[client_id])
VALUES ('http://localhost:3000/', 1);

INSERT INTO [{{cookiecutter.project_db_name}}].[dbo].[client_redirect_uris]
([redirect_uri] ,[client_id])
VALUES ('http://localhost:3000/Dashboard', 1);

INSERT INTO [{{cookiecutter.project_db_name}}].[dbo].[client_post_logout_redirect_uris]
