...
namespace {{cookiecutter.project_api_pkg_account}}.Identity.Authorization
{
    public static class ApiPermissions
    {
        ...
        public const string ApiName = "{{cookiecutter.project_api_name_account}}"; 
        public const string ApiPrefixName = "{{cookiecutter.project_api_const_pfx_account}}"; 

        //-------------------------------------
        // {{cookiecutter.project_api_name_account}} User & Role Management Permissions
        //-------------------------------------
